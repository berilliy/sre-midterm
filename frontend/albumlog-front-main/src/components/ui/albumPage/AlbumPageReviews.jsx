...
import fetchRecentReviewsAlbum from '../../../tools/FetchReviews/fetchRecentReviewsAlbum';

export default function AlbumPageReviews(props) {
  ...
  useEffect(() => {
    ...
    fetchRecentReviewsAlbum(obj, setRecentReviews, setPageCount, currentPage, setTotal)
  }, [currentPage])

  return (
    <div className="albumRecentReviews">
        <h2>Recent Reviews</h2>
        {recentReviews ? (recentReviews.length ? <p>{total} Total</p> : '') : ''}
